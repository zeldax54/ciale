...
class Raza
{
    ...
    /**
     * @var string
     * @ORM\Column(name="sugeridosmostrados", type="integer",nullable=true)
     */
    private $sugeridosmostrados;
    ...
    /**
     * Set sugeridosmostrados
     *
     * @param \number $sugeridosmostrados
     * @return Raza
     */
    public function setSugeridosmostrados($sugeridosmostrados)
    {
        $this->sugeridosmostrados = $sugeridosmostrados;

        return $this;
    }

    /**
     * Get sugeridosmostrados
     *
     * @return \number 
     */
    public function getSugeridosmostrados()
    {
        return $this->sugeridosmostrados;
    }
}
